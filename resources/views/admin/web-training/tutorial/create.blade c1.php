                                                ...
                                                <div class="col-lg-12" style="height: 350px; overflow: hidden; overflow-y: scroll;">
                                                    <div class="fallback">
                                                        <form action="" id="formdata" method="post" enctype="multipart/form-data">
                                                            @csrf
                                                            <input type="hidden" name="action" value="{{ route('tutorial.create.store') }}">
                                                            <input id="fancy_upload" type="file" name="fancy_upload" accept=".jpg, .png, image/jpeg, image/png" multiple>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
